...
* Spacemacs documentation (Spacemacs 文档)                                   :TOC_4_gh:noexport:
 - [[#core-pillars][Core Pillars (核心理念)]]
   - [[#mnemonic][Mnemonic (低廉的心智负担)]]
   - [[#discoverable][Discoverable (_)]]
   - [[#consistent][Consistent (高度的一致性)]]
   - [[#crowd-configured][Crowd-Configured (你不是一个人在配置)]]
 - [[#highlighted-feature][Highlighted feature (突出特性)]]
